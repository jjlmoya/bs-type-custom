...
function bs_custom_get_post_type()
{
	return Custom::getInstance('Costumbre', 'Costumbres', "costumbre",
		array()
	);
}

function bs_custom_register_post_type()
{
	$model = bs_custom_get_post_type();
	$labels = array(
...
function bs_custom_create_custom_params()
{
	$model = bs_custom_get_post_type();
...
function bs_custom_register($customType)
{
	$model = bs_custom_get_post_type();
...
function bs_custom_callback($fieldType)
{
	$model = bs_custom_get_post_type();
	$customField = $model->customFields;
...
function bs_custom_on_save($post_id)
{
